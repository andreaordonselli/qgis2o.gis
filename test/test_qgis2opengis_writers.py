...
from qgis2opengis.utils import tempFolder

from osgeo import gdal
from qgis2opengis.test.utilities import get_test_data_path, load_layer
from qgis.testing import unittest, start_app
from qgis.testing.mocked import get_iface

print("test_qgis2opengis_writers")
start_app()
...
class qgis2opengis_WriterTest(unittest.TestCase):
    ...
    def test36_OL3_layer_list(self):
        ...
        result = writer.write(self.iface, tempFolder()).index_file
        test_qgis2opengis_output = read_output(result, 'resources/qgis2opengis.js')
        assert 'new ol.control.LayerSwitcher' in test_qgis2opengis_output
    ...
    def test41_OL3_scalebar(self):
        ...
        # Open the test file
        test_output = read_output(result, 'resources/qgis2opengis.js')
    ...
    def test94_Leaflet_svg(self):
        ...
        assert os.path.exists(result.replace('index.html', 'markers/qgis2opengis.svg'))
    ...
    def test95_OL3_svg(self):
        ...
        # test for exported marker file
        assert os.path.exists(result.replace('index.html', 'styles/qgis2opengis.svg'))
...
if __name__ == "__main__":
    ...
    suite.addTests(unittest.makeSuite(qgis2opengis_WriterTest))
