...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@0@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="line_color" v="55,76,206,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="NAMES"/>
    ...
    <property key="qgis2opengis/popup/AREA_MI" value="no label"/>
    <property key="qgis2opengis/popup/NAMES" value="no label"/>
    <property key="qgis2opengis/popup/cat" value="no label"/>
    <property key="qgis2opengis/popup/rotation" value="no label"/>
    <property key="qgis2opengis/popup/xlabel" value="no label"/>
    <property key="qgis2opengis/popup/ylabel" value="no label"/>
