...
<qgis version="2.18.7" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="NAMES" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="1">
    <categories>
      <category render="true" symbol="0" value="Becharof Lake" label="Becharof Lake"/>
      <category render="true" symbol="1" value="Dall Lake" label="Dall Lake"/>
      <category render="true" symbol="2" value="Iliamna Lake" label="Iliamna Lake"/>
      <category render="true" symbol="3" value="Kenai Lake" label="Kenai Lake"/>
      <category render="true" symbol="4" value="Lake Clark" label="Lake Clark"/>
      <category render="true" symbol="5" value="Lake George" label="Lake George"/>
      <category render="true" symbol="6" value="Lake Minchumina" label="Lake Minchumina"/>
      <category render="true" symbol="7" value="Lake Nerka" label="Lake Nerka"/>
      <category render="true" symbol="8" value="Lower Ugashik Lake" label="Lower Ugashik Lake"/>
      <category render="true" symbol="9" value="Naknek Lake" label="Naknek Lake"/>
      <category render="true" symbol="10" value="Nunavakpak Lake" label="Nunavakpak Lake"/>
      <category render="true" symbol="11" value="Nuvakuk Lake" label="Nuvakuk Lake"/>
      <category render="true" symbol="12" value="Skilak Lake" label="Skilak Lake"/>
      <category render="true" symbol="13" value="Teshekpuk Lake" label="Teshekpuk Lake"/>
      <category render="true" symbol="14" value="Tustumena Lake" label="Tustumena Lake"/>
      <category render="true" symbol="15" value="" label=""/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="10">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@10@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="82,141,230,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@10@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="82,141,230,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="11">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@11@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="224,131,215,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@11@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="224,131,215,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="12">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@12@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="167,76,200,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@12@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="167,76,200,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="13">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@13@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="191,230,119,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@13@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="191,230,119,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="14">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@14@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="219,217,60,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@14@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="219,217,60,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="15">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@15@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="234,80,160,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@15@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="234,80,160,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="5">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@5@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="221,87,46,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@5@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="221,87,46,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="6">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@6@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="80,205,139,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@6@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="80,205,139,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="7">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@7@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="209,115,129,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@7@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="209,115,129,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="8">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@8@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="26,32,221,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@8@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="26,32,221,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="9">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="order_parts(   extrude(    segments_to_lines( $geometry ),    cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),    sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height )  ),  'distance(  $geometry,  translate(    @map_extent_center,    1000 * @map_extent_width * cos( radians( @qgis_25d_angle + 180 ) ),    1000 * @map_extent_width * sin( radians( @qgis_25d_angle + 180 ) )  ))',  False)"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@9@1">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="49,239,211,255"/>
              <prop k="color_dd_active" v="1"/>
              <prop k="color_dd_expression" v="set_color_part(   @symbol_color, 'value',  40 + 19 * abs( $pi - azimuth(     point_n( geometry_n($geometry, @geometry_part_num) , 1 ),     point_n( geometry_n($geometry, @geometry_part_num) , 2 )  ) ) )"/>
              <prop k="color_dd_field" v=""/>
              <prop k="color_dd_useexpr" v="1"/>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          <prop k="SymbolType" v="Fill"/>
          <prop k="geometryModifier" v="translate(  $geometry,  cos( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ),  sin( radians( eval( @qgis_25d_angle ) ) ) * eval( @qgis_25d_height ))"/>
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@9@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="49,239,211,255"/>
              <prop k="joinstyle" v="bevel"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@0@2">
            <layer pass="0" class="SimpleFill" locked="0">
              <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="color" v="177,169,124,255"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="qgis2opengis/popup/AREA_MI" value="inline label"/>
    <property key="qgis2opengis/popup/NAMES" value="no label"/>
    <property key="qgis2opengis/popup/cat" value="inline label"/>
    <property key="qgis2opengis/popup/rotation" value="inline label"/>
    <property key="qgis2opengis/popup/xlabel" value="inline label"/>
    <property key="qgis2opengis/popup/ylabel" value="inline label"/>
