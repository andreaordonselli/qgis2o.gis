...
from qgis2opengis.exporter import (FolderExporter,
                               FtpExporter,
                               FtpConfigurationDialog,
                               EXPORTER_REGISTRY)
from qgis2opengis.writer import (WriterResult)

from qgis.testing import start_app

print("test_qgis2opengis_exporters")
start_app()
...
class qgis2opengis_exporterTest(unittest.TestCase):
...
if __name__ == "__main__":
    ...
    suite.addTests(unittest.makeSuite(qgis2opengis_exporterTest))
