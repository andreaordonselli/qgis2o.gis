...
print("test_qgis2opengis_writerRegistry")
start_app()


class qgis2opengis_writerRegistryTest(unittest.TestCase):
...
if __name__ == "__main__":
    ...
    suite.addTests(unittest.makeSuite(qgis2opengis_writerRegistryTest))
