...
import re
from qgis2opengis.mapboxFileScripts import (writeFoldersAndFiles,
                                        writeCSS,
                                        writeHTMLstart)
from qgis2opengis.mapboxLayerScripts import writeVectorLayer
from qgis2opengis.mapboxScriptStrings import (jsonScript,
                                          ...
                                          getVTStyles,
                                          getVTLabels)
from qgis2opengis.utils import (ALL_ATTRIBUTES, PLACEMENT, exportVector,
                            exportRaster, safeName, scaleToZoom)
from qgis2opengis.writer import (Writer,
                             WriterResult,
                             translator)
from qgis2opengis.feedbackDialog import Feedback
from qgis2opengis.bridgestyle.qgis import layerStyleAsMapbox
...
var styleJSON = {
    ...
    "layers": [%s],
        ...
        attribution = ('<a href='
                       '"https://github.com/tomchadwin/qgis2opengis" '
                       'target="_blank">qgis2opengis</a> &middot; '
...
%s%s</script>""" % (center, zoom, bearing, attribution, popupCode, layersList,
        ...
        #     QgsMessageLog.logMessage(traceback.format_exc(), "qgis2opengis",
