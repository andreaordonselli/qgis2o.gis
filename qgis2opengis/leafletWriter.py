...
import re
from qgis2opengis.leafletFileScripts import (writeFoldersAndFiles,
                                         writeCSS,
                                         writeHTMLstart)
from qgis2opengis.leafletLayerScripts import writeVectorLayer
from qgis2opengis.leafletScriptStrings import (jsonScript,
                                           ...
                                           getVTStyles,
                                           getVTLabels)
from qgis2opengis.utils import (ALL_ATTRIBUTES, exportVector,
    ...
    def writeLeaflet(
        ...
        try:
            ...
            QgsMessageLog.logMessage(traceback.format_exc(),
                                     "qgis2opengis", level=Qgis.Critical)
        finally:
