...
import shutil
import codecs
from qgis2opengis.utils import replaceInTemplate
...
def writeFoldersAndFiles(pluginDir, feedback, outputProjectFileName,
    ...
    shutil.copyfile(jsDir + 'qgis2opengis_expressions.js',
                    jsStore + 'qgis2opengis_expressions.js')
...
def writeHTMLstart(outputIndex, webpage_name, cluster_set, address, measure,
                   ...
                   qgis2opengisJS, template, feedback, useMultiStyle, useHeat,
    ...
    extracss = '<link rel="stylesheet" href="css/qgis2opengis.css">'
    ...
    if (matchCRS and
        ...
        crsJS = ""
    exp_js = """
        <script src="js/qgis2opengis_expressions.js"></script>"""
...
def writeCSS(cssStore, backgroundColor, feedback, widgetAccent,
    ...
    with open(cssStore + 'qgis2opengis.css', 'w') as f_css:
        text = """
        #map {
